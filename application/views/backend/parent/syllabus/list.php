        ...
        <tbody>
            <?php foreach($syllabuses as $syllabus):?>
                <tr>
                    ...
                    <td><a href="<?php echo base_url($this->config->item('asset_url').'/syllabus/'.$syllabus['file']); ?>" class="btn btn-info mdi mdi-download" download><?php echo get_phrase('download'); ?></a></td>
