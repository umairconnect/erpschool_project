...
<div class="row ">
  <div class="col-xl-12">
    <div class="card">
      <div class="card-body">
        <h4 class="page-title">
            <i class="mdi mdi-book-open-page-variant title_icon"></i> Student
        </h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form method="POST" class="d-block studentSignup" action="<?php echo route('student/insert'); ?>">
            <div class="col-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-4 mb-1">
                            ...
                            <input type="numeric" id="teacher_3" name="teacher_3" class="form-control school_code"  value="Student" readonly>
                        </div>
                        <div class="form-group col-lg-4 mb-1">
                ...
                <div class="card-body">
                    <div class="row"> 
                        <div class="col-lg-12">
                            ...
                            <div class="">
                                <input type="submit" class="btn btn-success float-right col-xl-3 col-lg-3 col-md-12 col-sm-12" value="<?php echo get_phrase('create_class'); ?>"  onclick="studentSignup()">
                            </div>
                        </div>
                    </div>
                </div>
