...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form method="POST" class="d-block teacherSignup" action="<?php echo route('teacher/insert'); ?>">
                <div class="col-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-4 mb-1">
                            ...
                            <input type="numeric" id="teacher_3" name="teacher_3" class="form-control school_code"  value="Teacher" readonly>
                        </div>
                        <div class="form-group col-lg-4 mb-1">
                    ...
                    <div class="form-group row">
                        <div class="form-group col-lg-3">
                            ...
                            <input type="numeric" class="form-control" id="teacher_5" name="teacher_5">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-4"> 
                            ...
                            <select type="text" id="teacher_8" name="teacher_8" class="form-control" >
                    ...
                    <div class="form-group row mb-1 teacher_9_10">
                    ...
                    <div class="form-group row">
                        <div class="form-group col-lg-3"> 
                            ...
                            <select type="text" id="teacher_11" name="teacher_11" class="form-control" required>
                    ...
                    <div class="form-group row">
                        <div class="form-group col-lg-5"> 
                            ...
                            <select type="text" id="teacher_13" name="teacher_13" class="form-control" >
                        ...
                        <div class="form-group col-lg-4 "> 
                            ...
                            <select type="text" id="teacher_14" name="teacher_14" class="form-control chosen">
                                <option value="">Select</option>
                    ...
                    <div class="form-group row teacher_15a">
                        <div class="form-group col-lg-4"> 
                            <label for="teacher_15a">Birth UF</label>
                            <select type="text" id="teacher_15a" name="teacher_15a" class="form-control" >
                                <option value="">Select</option>
                        ...
                        <div class="form-group col-lg-5"> 
                            ...
                            <select type="text" id="teacher_15" name="teacher_15" class="form-control chosen" >
                                <option value="">Select</option>
                    ...
                    <div class="form-group row teacher_42_group">   
                ...
                <div class="card-body">
                    <div class="row"> 
                        <div class="col-lg-12">
                            ...
                            <div class="">
                                <input type="submit" class="btn btn-success float-right col-xl-3 col-lg-3 col-md-12 col-sm-12" value="<?php echo get_phrase('create_class'); ?>"  onclick="teacherSignup()">
                            </div>
                        </div>
                    </div>
                </div>
...
$("#teacher_14_chosen").hide(); 
$("#teacher_14").css("display","block");
$("#teacher_14").val("Brasil");
...
$("#teacher_13").change(function(){
    ...
    {
        $("#teacher_14_chosen").show(); 
        $("#teacher_14").css("display","none");
        $("#teacher_15").prop("disabled", false );  
        $(".teacher_15a").show(); 
    }
});
...
// $(".teacher_42_group").hide();

$("#teacher_41").change(function() {
    if($(this).val() == "76")
    {  
    $(".teacher_42_group").show();  
...
if($('.teacherSignup').valid()) {
  
  $(".teacherSignup").submit(function(e) {
    var form = $(this);
