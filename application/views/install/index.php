...
<head>
	...
	<link rel="shortcut icon" href="<?php echo base_url($this->config->item('asset_url').'/system/logo/favicon.png'); ?>">
	...
	<header class="navbar navbar-fixed-top" style="min-height: 80px; background: linear-gradient(135deg,#0F2027 0,#2C5364 60%) !important;">
		<div class="navbar-inner">
			...
			<div class="navbar-brand">
				<a href="#">
					<img src="<?php echo base_url($this->config->item('asset_url').'/system/logo/logo-light.png');?>"  style="max-height:40px;"/>
				</a>
			</div>
