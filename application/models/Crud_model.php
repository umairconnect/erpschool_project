...
class Crud_model extends CI_Model {
	...
	public function get_school(){
		return $this->db->get('schools');

	}

	public function register_new_class(){

		$data['name'] = $this->input->post('name');

		$data['school_id'] = $this->input->post('school_id');

		if($this->input->post('record_type'))
		$data['1_classes'] = $this->input->post('record_type');
				
		if($this->input->post('class_3'))
		$data['3_classes'] = $this->input->post('class_3');

		if($this->input->post('class_4'))
		$data['4_classes'] = $this->input->post('class_4');
				
		if($this->input->post('class_6'))
		$data['6_classes'] = $this->input->post('class_6');
		
		if($this->input->post('class_7'))
		$data['7_classes'] = $this->input->post('class_7');
		
		if($this->input->post('class_8'))
		$data['8_classes'] = $this->input->post('class_8');
		
		if($this->input->post('class_9'))
		$data['9_classes'] = $this->input->post('class_9');
		
		if($this->input->post('class_10'))
		$data['10_classes'] = $this->input->post('class_10');
		
		if($this->input->post('class_11')){
		  foreach($this->input->post('class_11') as $checked){
			$data[$checked.'_classes'] = 1; 
		  }
		} 	
		
		if($this->input->post('class_18')){
		  foreach($this->input->post('class_18') as $checked){
			$data[$checked.'_classes'] = 1; 
		  }
		}

		if($this->input->post('class_21'))
		$data['21_classes'] = $this->input->post('class_21');

		if($this->input->post('class_22'))
		$data['22_classes'] = $this->input->post('class_22');

		if($this->input->post('class_23'))
		$data['23_classes'] = $this->input->post('class_23');

		if($this->input->post('class_24'))
		$data['24_classes'] = $this->input->post('class_24');
				
		if($this->input->post('class_25'))
		$data['25_classes'] = $this->input->post('class_25');

		if($this->input->post('class_26'))
		$data['26_classes'] = $this->input->post('class_26');
		
		if($this->input->post('class_27'))
		$data['27_classes'] = $this->input->post('class_27');
				
		if($this->input->post('class_28'))
		$data['28_classes'] = $this->input->post('class_28');

		if($this->input->post('class_29'))
		$data['29_classes'] = $this->input->post('class_29');

		if($this->input->post('class_30'))
		$data['30_classes'] = $this->input->post('class_30');

		if($this->input->post('areas')){
			$areas = array();
			foreach($this->input->post('areas') as $checked){
				$areas[] = $checked;
			}
			$areas = implode(',', $areas);

			$data['knowledge_areas'] = $areas;			
		  }
		  

		// if($this->input->post('subject_1'))
		// $data['31_classes'] = $this->input->post('subject_1');

		// if($this->input->post('subject_2'))
		// $data['32_classes'] = $this->input->post('subject_2');

		// if($this->input->post('subject_3'))
		// $data['33_classes'] = $this->input->post('subject_3');

		// if($this->input->post('subject_4'))
		// $data['34_classes'] = $this->input->post('subject_4');
				
		// if($this->input->post('subject_5'))
		// $data['35_classes'] = $this->input->post('subject_5');

		// if($this->input->post('subject_6'))
		// $data['36_classes'] = $this->input->post('subject_6');
		
		// if($this->input->post('subject_7'))
		// $data['37_classes'] = $this->input->post('subject_7');
				
		// if($this->input->post('subject_8'))
		// $data['38_classes'] = $this->input->post('subject_8');

		// if($this->input->post('subject_9'))
		// $data['39_classes'] = $this->input->post('subject_9');
		
		// if($this->input->post('subject_10'))
		// $data['40_classes'] = $this->input->post('subject_10');

		// if($this->input->post('subject_11'))
		// $data['41_classes'] = $this->input->post('subject_11');

		// if($this->input->post('subject_12'))
		// $data['42_classes'] = $this->input->post('subject_12');

		// if($this->input->post('subject_13'))
		// $data['43_classes'] = $this->input->post('subject_13');

		// if($this->input->post('subject_14'))
		// $data['44_classes'] = $this->input->post('subject_14');
				
		// if($this->input->post('subject_16'))
		// $data['45_classes'] = $this->input->post('subject_16');

		// if($this->input->post('subject_17'))
		// $data['46_classes'] = $this->input->post('subject_17');
		
		// if($this->input->post('subject_23'))
		// $data['47_classes'] = $this->input->post('subject_23');
				
		// if($this->input->post('subject_25'))
		// $data['48_classes'] = $this->input->post('subject_25');

		// if($this->input->post('subject_26'))
		// $data['49_classes'] = $this->input->post('subject_26');	
		
		// if($this->input->post('subject_27'))
		// $data['50_classes'] = $this->input->post('subject_27');	
		
		// if($this->input->post('subject_28'))
		// $data['51_classes'] = $this->input->post('subject_28');

		// if($this->input->post('subject_29'))
		// $data['52_classes'] = $this->input->post('subject_29');

		// if($this->input->post('subject_30'))
		// $data['53_classes'] = $this->input->post('subject_30');

		// if($this->input->post('subject_31'))
		// $data['54_classes'] = $this->input->post('subject_31');
				
		// if($this->input->post('subject_32'))
		// $data['55_classes'] = $this->input->post('subject_32');

		// if($this->input->post('subject_99'))
		// $data['56_classes'] = $this->input->post('subject_99');	
		
		if($this->db->insert('classes', $data))
		{
		$response = array(
		  'status' => true,
		  'notification' => get_phrase('data_inserted_successfully')
		);
	...
	//START CLASS section
	public function get_class($code) {
		$class = $this->db->get_where('classes', array('4_classes' => $code))->result_array();
		return json_encode($class);
	}	

	public function get_areas($code) {

		$class = $this->db->get_where('modality_steps', array('step_code' => $code))->result_array();
		// $area = array();
		...
		$this->db->where_in('course_code',$area);
		return json_encode($this->db->get('knowledge_area')->result_array());

		// return json_encode($areas);
	}	
		
	public function get_steps($code) {

		$steps = $this->db->get_where('modality_steps', array('modality_'.$code => 1))->result_array();
	...
	public function syllabus_create($param1 = '')
	{
		...
		move_uploaded_file($_FILES['syllabus_file']['tmp_name'], $this->config->item('asset_url').'/syllabus/'.$data['file']);
	...
	public function syllabus_delete($param1){
		...
		$path = $this->config->item('asset_url').'/syllabus/'.$syllabus_details['file'];
		if (file_exists($path)){
				unlink($path);
		}
		$response = array(
	...
	public function create_notice() {
		...
		if ($_FILES['notice_photo']['name'] != '') {
			...
			move_uploaded_file($_FILES['notice_photo']['tmp_name'], $this->config->item('asset_url').'/images/notice_images/'. $data['image']);
		}else{
	...
	public function get_noticeboard_image($image) {
		if (file_exists($this->config->item('asset_url').'/images/notice_images/'.$image))
		return base_url().$this->config->item('asset_url').'/images/notice_images/'.$image;
		else
		return base_url().$this->config->item('asset_url').'/images/notice_images/placeholder.png';
	}
