										...
										<div class="custom-file">
						                    <div class="custom-file">
											    ...
											    <?php if($question_answer->num_rows('answer') > 0): ?>
											    	<small class="float-right"><a href="<?php echo base_url($this->config->item('asset_url').'/assignment_files/'.$question_answer->row('answer')); ?>" download><?php echo get_phrase('download_previews_file'); ?></a></small>
											    <?php endif; ?>
											</div>
										</div>
									<?php endif; ?>
