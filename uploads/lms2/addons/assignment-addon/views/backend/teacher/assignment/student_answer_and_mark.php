                            ...
                            <?php if($question_answer['id'] > 0): ?>
                                <form action="javascript:;" method="POST" enctype="multipart/form-data">
                                    <div class="form-group bg-white p-3">
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo base_url($this->config->item('asset_url').'/assignment_files/'.$question_answer['answer']); ?>" class="btn btn-info btn-sm ml-4" download><i class="mdi mdi-download"></i> <?php echo get_phrase('download'); ?></a>
                                        <?php endif; ?>
                                    </div>
