                                            ...
                                            <div class="form-group row mb-3">
                                              ...
                                              <div class="col-md-10">
                                                <div class="wrapper-image-preview .ml--6">
                                                  <div class="box w-250">
                                                    <?php if(file_exists($this->config->item('asset_url').'/course_thumbnail/'.$course['thumbnail'])): ?>
                                                      <div class="js--image-preview bg-F5F5F5" style="background-image: url(<?php echo base_url($this->config->item('asset_url').'/course_thumbnail/'.$course['thumbnail']); ?>);"></div>
                                                    <?php else: ?>
                                                      <div class="js--image-preview bg-F5F5F5" style="background-image: url(<?php echo base_url($this->config->item('asset_url').'/course_thumbnail/placeholder.png'); ?>);"></div>
                                                    <?php endif; ?>
