		...
		<tr>
			...
			<td>
				<small>
					...
					<?php if ($live_class['attachment'] != ""): ?>
						<br><strong><?php echo get_phrase("attachment"); ?></strong> : <a href="<?php echo base_url($this->config->item('asset_url').'/live_class/'.$live_class['attachment']); ?>" class="" download><strong><?php echo get_phrase("download"); ?></strong> </a>
					<?php endif; ?>
				</small>
			</td>
			<td class="text-center">
				<div class="btn-group">
					...
					<button type="button" class="btn btn-primary dropdown-btn dropdown-toggle arrow-none card-drop text-white" data-toggle="dropdown" aria-expanded="false"><i class="mdi mdi-dots-vertical"></i></button>
